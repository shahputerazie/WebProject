...
<%
    ...
    for (BookingRequest booking : allBookings) {
        ...
        if (booking.getStatus() == BookingRequest.Status.PENDING) pendingRequests++;
        else if (booking.getStatus() == BookingRequest.Status.APPROVED) approvedRequests++;
        else if (booking.getStatus() == BookingRequest.Status.CANCELLED) cancelledRequests++;
    }
%>
<!DOCTYPE html>
                            ...
                            <tbody class="divide-y divide-surface">
                                ...
                                <% } else {
                                    ...
                                    for (int i = 0; i < maxRows; i++) {
                                        ...
                                        if ("PENDING".equals(statusLabel)) badgeClass = "bg-amber-100 text-amber-800";
                                        else if ("APPROVED".equals(statusLabel)) badgeClass = "bg-primary-container text-primary-fixed-dim";
                                        else if ("CANCELLED".equals(statusLabel)) badgeClass = "bg-error-container text-on-error-container";
                                %>
